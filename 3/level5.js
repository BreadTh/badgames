...
var KW5_5 = [B.KILL, S.FLAT, 5];      // kill wall h=5
var KW5_6 = [B.KILL, S.FLAT, 6];      // kill wall h=6
...
LEVELS.push({
  ...
  rows: concat(
    ...
    // 2b: Gentle split (40r) — left has bumps+fuel, right has gaps+oxy
    // Left: cols 0-8 with h=1 bumps
    repeat([N,N,N,N,H(1), H(1),N,N,N,KC(4), KC(4),N,N,N,N, N,N,N,N,N], 4),
    repeat([N,FU5,N,N,N, N,N,N,N,KC(4), KC(4),N,N,N,N, N,N,OX5,N,N], 6),
    repeat([N,N,N,H(1),H(1), H(1),N,N,N,KC(4), KC(4),N,N,N,0, 0,N,N,N,N], 4),
    repeat([N,N,N,N,N, N,N,N,N,KC(4), KC(4),N,N,N,N, N,N,N,N,N], 4),
    repeat([N,N,H(1),N,N, N,N,FU5,N,KC(4), KC(4),N,N,0,0, N,N,N,OX5,N], 6),
    repeat([N,N,N,N,N, H(1),H(1),N,N,KC(4), KC(4),N,N,N,N, N,N,N,N,N], 4),
    repeat([N,N,N,N,N, N,N,N,N,KC(4), KC(4),N,N,N,N, 0,0,N,N,N], 4),
    repeat([N,N,FU5,N,N, N,N,N,N,KC(4), KC(4),N,N,N,N, N,N,N,OX5,N], 4),
    repeat([N,N,N,N,H(1), N,N,N,N,KC(4), KC(4),N,N,N,N, N,N,N,N,N], 4),
    ...
    // Wall at cols 10-11
    repeat([N,N,N,N,N, N,N,N,N,N, KC(5),KC(5),N,N,N, N,N,N,N,N], 4),
    // Left: drain floor with h=2 resource platforms
    repeat([DF5,DF5,DF5,DF5,H(2), HF(2),H(2),DF5,DF5,DF5, KC(5),KC(5),N,N,N, N,N,N,N,N], 6),
    repeat([DF5,DF5,DF5,DF5,DF5, DF5,DF5,DF5,DF5,DF5, KC(5),KC(5),N,N,N, H(1),H(1),N,N,N], 6),
    repeat([DF5,DF5,H(2),HO(2),H(2), DF5,DF5,DF5,DF5,DF5, KC(5),KC(5),N,N,N, N,N,N,N,N], 6),
    repeat([DF5,DF5,DF5,DF5,DF5, DF5,DF5,DF5,DF5,DF5, KC(5),KC(5),N,N,N, N,N,H(1),N,N], 6),
    repeat([DF5,DF5,DF5,DF5,DF5, DF5,H(2),HF(2),HO(2),DF5, KC(5),KC(5),N,N,N, N,N,N,N,N], 6),
    repeat([DF5,DF5,DF5,DF5,DF5, DF5,DF5,DF5,DF5,DF5, KC(5),KC(5),N,N,N, N,N,N,N,N], 4),
    // Right: gentle ground, sparse pickups
    repeat([DF5,DF5,DF5,H(2),HF(2), H(2),DF5,DF5,DF5,DF5, KC(5),KC(5),N,N,N, N,N,N,OX5,N], 6),
    repeat([DF5,DF5,DF5,DF5,DF5, DF5,DF5,DF5,DF5,DF5, KC(5),KC(5),N,N,N, N,N,N,N,N], 6),
    ...
    // Center 4 lanes (8-11) are fuel drain, left has kill blocks, right has gaps
    repeat([N,N,N,N,N, N,N,N,DF5,DF5, DF5,DF5,N,N,N, N,N,N,N,N], 4),
    repeat([N,N,KF5,KF5,N, N,N,N,DF5,DF5, DF5,DF5,N,N,N, N,N,N,N,N], 6),
    repeat([N,FU5,N,N,N, N,N,N,DF5,DF5, DF5,DF5,N,N,0, 0,N,N,OX5,N], 6),
    repeat([N,N,N,N,KF5, N,N,N,DF5,DF5, DF5,DF5,N,N,N, N,N,N,N,N], 6),
    repeat([N,N,N,N,N, N,FU5,N,DF5,DF5, DF5,DF5,N,0,0, N,N,OX5,N,N], 6),
    repeat([N,N,N,N,N, KF5,N,N,DF5,DF5, DF5,DF5,N,N,N, N,N,N,N,N], 6),
    repeat([N,N,FU5,N,N, N,N,N,DF5,DF5, DF5,DF5,N,N,N, 0,0,N,OX5,N], 6),

    // 5b: Oxy drain moat (30r)
    // Center switches to oxy drain
    repeat([N,N,N,N,N, N,N,N,DO5,DO5, DO5,DO5,N,N,N, N,N,N,N,N], 4),
    repeat([N,N,H(1),H(1),N, OX5,N,N,DO5,DO5, DO5,DO5,KW5,N,N, N,FU5,N,N,N], 6),
    repeat([N,N,N,N,H(2), H(2),OX5,N,DO5,DO5, DO5,DO5,N,N,KW5, N,N,N,N,N], 6),
    repeat([N,N,N,N,N, N,N,N,DO5,DO5, DO5,DO5,N,N,N, KW5,N,FU5,N,N], 6),
    repeat([N,OX5,N,H(1),N, N,N,N,DO5,DO5, DO5,DO5,KW5,N,N, N,N,N,N,N], 8),

    // 5c: Double drain (30r)
    // cols 8-9 fuel drain, cols 10-11 oxy drain
    repeat([N,N,N,N,N, N,N,N,DF5,DF5, DO5,DO5,N,N,N, N,N,N,N,N], 4),
    repeat([N,N,KF5,N,N, N,FU5,N,DF5,DF5, DO5,DO5,N,N,0, 0,N,OX5,N,N], 6),
    repeat([N,N,N,N,KF5, N,N,N,DF5,DF5, DO5,DO5,N,N,N, N,N,N,N,N], 6),
    repeat([N,OX5,N,N,N, N,N,N,DF5,DF5, DO5,DO5,N,0,0, N,FU5,N,N,N], 6),
    repeat([N,N,N,N,N, KF5,N,N,DF5,DF5, DO5,DO5,N,N,N, N,N,N,N,N], 4),
    repeat(F, 4),
    ...
    // 10d: Zigzag split (40r) — paths narrow behind fixed wall
    repeat([N,N,N,N,N, N,N,N,N,KC(4), KC(4),N,N,N,N, N,N,N,N,N], 4),
    // Narrowing: kill blocks close from edges
    repeat([KW5,N,N,N,N, N,N,N,N,KC(4), KC(4),N,N,N,N, N,N,N,N,KW5], 4),
    repeat([KW5,KW5,N,N,N, N,FU5,N,N,KC(4), KC(4),N,N,OX5,N, N,N,N,KW5,KW5], 4),
    repeat([KW5,KW5,KW5,N,N, N,N,N,N,KC(4), KC(4),N,N,N,N, N,N,KW5,KW5,KW5], 4),
    // Hold at narrowest — dense resources reward commitment
    repeat([KW5,KW5,KW5,N,FU5, N,N,N,N,KC(4), KC(4),N,N,N,N, OX5,N,KW5,KW5,KW5], 4),
    repeat([KW5,KW5,KW5,N,N, N,OX5,N,N,KC(4), KC(4),N,N,FU5,N, N,N,KW5,KW5,KW5], 6),
    // Crossover at narrowest
    repeat(F, 4),
    // Reopens
    repeat([KW5,KW5,KW5,N,N, N,N,N,N,KC(4), KC(4),N,N,N,N, N,N,KW5,KW5,KW5], 4),
    repeat([KW5,KW5,N,N,OX5, N,N,N,N,KC(4), KC(4),N,N,N,N, FU5,N,N,KW5,KW5], 4),
    repeat([KW5,N,N,N,N, N,N,N,N,KC(4), KC(4),N,N,N,N, N,N,N,N,KW5], 4),
    repeat([N,N,N,N,N, N,N,N,N,KC(4), KC(4),N,N,N,N, N,N,N,N,N], 4),
    repeat(F, 4),
    ...
    // Left: kill floor gap. Right: corridor holds
    repeat([KF5,KF5,KF5,KF5,KF5, KF5,KF5,KF5,KF5,KC(6), KC(6),KW5,N,N,N, N,N,N,KW5,KW5], 14),
    ...
    // Kill floor gap, right corridor shifts
    repeat([KF5,KF5,KF5,KF5,KF5, KF5,KF5,KF5,KF5,KC(6), KC(6),N,N,N,KW5, N,N,N,N,KW5], 12),
    ...
    // Kill floor gap, right corridor
    repeat([KF5,KF5,KF5,KF5,KF5, KF5,KF5,KF5,KF5,KC(6), KC(6),N,N,N,KW5, KW5,N,N,N,KW5], 12),
    ...
    repeat([N,N,N,N,KW5, KW5,KW5,KW5,KW5,KC(6), KC(6),KF5,KF5,KF5,KF5, KF5,KF5,KF5,KF5,KF5], 10),

    // Cycle 2 (22r): Left corridor cols 2-5. Right island cols 12-16 (8r+2r pad+12r gap).
    repeat([KW5,KW5,N,N,N, N,KW5,KW5,KW5,KC(6), KC(6),KF5,H(1),H(1),HF(1), H(1),H(1),KF5,KF5,KF5], 4),
    repeat([KW5,KW5,N,N,OX5, N,KW5,KW5,KW5,KC(6), KC(6),KF5,H(1),H(1),H(1), H(1),H(1),KF5,KF5,KF5], 4),
    repeat([KW5,KW5,N,N,N, N,KW5,KW5,KW5,KC(6), KC(6),KF5,H(1),JP5(1),JP5(1), H(1),KF5,KF5,KF5,KF5], 2),
    repeat([KW5,N,N,N,N, N,KW5,KW5,KW5,KC(6), KC(6),KF5,KF5,KF5,KF5, KF5,KF5,KF5,KF5,KF5], 12),

    // Cycle 3 (22r): Left corridor cols 0-2 (3-wide). Right island cols 14-18 (8r+2r pad+12r gap).
    repeat([N,N,N,KW5,KW5, KW5,KW5,KW5,KW5,KC(6), KC(6),KF5,KF5,KF5,H(1), H(1),HF(1),H(1),H(1),KF5], 4),
    repeat([N,OX5,N,KW5,KW5, KW5,KW5,KW5,KW5,KC(6), KC(6),KF5,KF5,KF5,H(1), H(1),H(1),H(1),H(1),KF5], 4),
    repeat([N,N,N,KW5,KW5, KW5,KW5,KW5,KW5,KC(6), KC(6),KF5,KF5,KF5,H(1), JP5(1),JP5(1),H(1),KF5,KF5], 2),
    repeat([KW5,N,N,N,N, KW5,KW5,KW5,KW5,KC(6), KC(6),KF5,KF5,KF5,KF5, KF5,KF5,KF5,KF5,KF5], 12),
    ...
    repeat([KF5,KF5,KF5,KF5,KF5, KF5,KF5,KF5,KF5,KC(6), KC(6),KW5,KW5,N,N, N,KW5,KW5,KW5,KW5], 8),

    // Cycle 2: medium (10r island, 2r pad, 10r gap = 22r)
    // Left: island cols 2-5 h=1. Right: corridor cols 14-16.
    repeat([KF5,KF5,H(1),H(1),H(1), H(1),KF5,KF5,KF5,KC(6), KC(6),KW5,KW5,KW5,N, N,N,KW5,KW5,KW5], 4),
    repeat([KF5,KF5,H(1),HF(1),H(1), H(1),KF5,KF5,KF5,KC(6), KC(6),KW5,KW5,KW5,N, OX5,N,KW5,KW5,KW5], 4),
    repeat([KF5,KF5,H(1),H(1),H(1), H(1),KF5,KF5,KF5,KC(6), KC(6),KW5,KW5,KW5,N, N,N,KW5,KW5,KW5], 2),
    repeat([KF5,KF5,H(1),JP5(1),JP5(1), H(1),KF5,KF5,KF5,KC(6), KC(6),KW5,KW5,KW5,N, N,N,KW5,KW5,KW5], 2),
    repeat([KF5,KF5,KF5,KF5,KF5, KF5,KF5,KF5,KF5,KC(6), KC(6),KW5,KW5,KW5,N, N,N,KW5,KW5,KW5], 10),
    ...
    // 20r: kill wall weave
    repeat([N,N,KW5,KW5,N, N,N,N,N,N, KW5,KW5,N,N,N, N,N,N,N,N], 4),
    repeat([N,N,N,N,N, KW5,KW5,N,N,N, N,N,N,KW5,KW5, N,N,N,N,N], 4),
    repeat([N,N,N,N,N, N,N,FU5,N,N, N,N,KW5,KW5,N, N,N,N,KW5,KW5], 4),
    repeat([KW5,KW5,N,N,N, N,N,N,N,KW5, KW5,N,N,N,N, N,N,N,N,N], 4),
    repeat([N,N,N,N,KW5, N,N,N,N,N, N,N,N,N,N, KW5,KW5,N,OX5,N], 4),

    // 20r: gap islands
    repeat([N,N,N,N,N, N,N,N,0,0, 0,N,N,N,N, N,N,N,N,N], 4),
    repeat([N,N,OX5,N,N, N,N,N,N,N, N,N,0,0,0, N,N,N,N,N], 4),
    repeat([N,N,N,N,0, 0,0,N,N,N, N,N,N,N,N, N,N,FU5,N,N], 4),
    repeat([N,N,N,N,N, N,N,N,N,N, 0,0,0,N,N, N,N,N,N,N], 4),
    repeat([N,N,N,N,N, N,N,N,N,N, N,N,N,N,N, 0,0,0,N,N], 4),
    repeat([N,N,N,0,0, 0,N,N,N,N, N,N,N,N,N, N,N,N,OX5,N], 6),
    ...
    // 20r: drain field zigzag
    repeat([DF5,DF5,DF5,DF5,DF5, DF5,DF5,DF5,N,N, N,N,DO5,DO5,DO5, DO5,DO5,DO5,DO5,DO5], 6),
    repeat([DF5,DF5,DF5,DF5,DF5, DF5,DF5,DF5,DF5,DF5, N,N,N,N,DO5, DO5,DO5,DO5,DO5,DO5], 4),
    repeat([DF5,DF5,DF5,DF5,DF5, N,N,N,N,DF5, DO5,DO5,DO5,DO5,DO5, DO5,DO5,DO5,DO5,DO5], 4),
    repeat([DF5,DF5,DF5,DF5,DF5, DF5,DF5,DF5,N,N, N,OX5,DO5,DO5,DO5, DO5,DO5,DO5,DO5,DO5], 6),

    // 13c: The narrowing (40r)
    repeat(F, 2),
    // 20-wide → 16-wide
    repeat([KW5_3,KW5_3,N,N,N, N,N,N,N,N, N,N,N,N,N, N,N,N,KW5_3,KW5_3], 8),
    // 16-wide → 12-wide
    repeat([KW5_3,KW5_3,KW5_3,KW5_3,N, N,N,N,N,N, N,N,N,N,N, N,KW5_3,KW5_3,KW5_3,KW5_3], 10),
    // 12-wide → 8-wide
    ...
    // 13d: Final corridor (20r)
    // 6-wide corridor with scattered kill blocks inside
    repeat([KW5_4,KW5_4,KW5_4,KW5_4,KW5_4, KW5_4,KW5_4,N,N,N, N,N,N,KW5_4,KW5_4, KW5_4,KW5_4,KW5_4,KW5_4,KW5_4], 4),
    repeat([KW5_4,KW5_4,KW5_4,KW5_4,KW5_4, KW5_4,KW5_4,N,KF5,N, N,KF5,N,KW5_4,KW5_4, KW5_4,KW5_4,KW5_4,KW5_4,KW5_4], 4),
    repeat([KW5_4,KW5_4,KW5_4,KW5_4,KW5_4, KW5_4,KW5_4,N,N,FU5, N,N,N,KW5_4,KW5_4, KW5_4,KW5_4,KW5_4,KW5_4,KW5_4], 4),
    repeat([KW5_4,KW5_4,KW5_4,KW5_4,KW5_4, KW5_4,KW5_4,KF5,N,N, N,N,KF5,KW5_4,KW5_4, KW5_4,KW5_4,KW5_4,KW5_4,KW5_4], 4),
    repeat([KW5_4,KW5_4,KW5_4,KW5_4,KW5_4, KW5_4,KW5_4,N,N,N, N,N,N,KW5_4,KW5_4, KW5_4,KW5_4,KW5_4,KW5_4,KW5_4], 4),
